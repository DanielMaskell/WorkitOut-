...
class manager_add_arrangement : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_manager_add_arrangement)
    }

   /* class manager_add_arrangement : AppCompatActivity(), View.OnClickListener {

        private val activity = this@manager_add_arrangement
...
/*
    ...
    btn_insert.setOnClickListener({
        if(btMonday_Work1.text.toString().length > 0 && btTuesday_Work2.text.toString().length > 0
            btWednesday_Work3.text.toString().length > 0 && btTursday_Work4.text.toString().length > 0 &&
            btFriday_Work5.text.toString().length > 0 && btSaturday_Work6.text.toString().length > 0 &&
            btSunday_Work7.text.toString().length > 0 && btExtra_Work8.text.toString().length > 0 &&)
            WORKINFO_EMPLOYEE_NAME.text.toString().length > 0 &&
